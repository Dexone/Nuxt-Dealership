      ...
      <div class="relative w-full max-w-4xl">
        ...
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
          <div class="duration-700 ease-in-out">
            <img :src="product.data.image[0][imageCount]"
        ...
        <div class="grid gap-4 mx-20">
          <div class="grid grid-cols-5 gap-4">
            <div v-for="(image, index) in product.data.image[0]">
              <img :class="{ 'bg-blue-50': index == imageCount }" class="h-auto max-w-full rounded-lg" :src="image"
                alt="" @click="imageCount = index" />
            </div>
          </div>
        </div>

        <button :class="{ hidden: imageCount <= 1 }"
        ...
        <button :class="{ hidden: imageCount >= 5 }"
        ...
        <div class="w-full max-w-sm p-8 px-16 bg-gray-50 border border-gray-200 rounded-lg shadow">
          ...
          <ul role="list" class="space-y-5 my-7">
            <li class="flex items-center">
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Год выпуска: {{ product.data.year
                }}</span>
            </li>
            <li class="flex">
              <svg class="w-6 h-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Мощность: {{ product.data.power }}
                л/с</span>
            </li>
            ...
            <li class="flex">
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Кузов: {{ product.data.bodyCar
                }}</span>
            </li>
            ...
            <li class="flex">
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Трансмиссия: {{
                product.data.transmission }}</span>
            </li>
            ...
            <li class="flex">
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Тип двигателя: {{ product.data.engine
                }}</span>
            </li>
            ...
            <li class="flex">
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Цвет: {{ product.data.color }}</span>
            </li>
            ...
            <li class="flex">
              ...
              <span class="text-base font-normal leading-tight text-gray-900 ms-3">Цена: {{
                product.data.price.toLocaleString() }} ₽</span>
            </li>
          </ul>
        </div>
      </div>
