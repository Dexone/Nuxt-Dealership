<template>
  ...
  <div class="bg-gray-50  border border-gray-200 rounded-lg shadow p-6 mx-auto mt-5  max-w-6xl"
...
<script setup>
import FavouriteProduct from '@/src/components/index/FavouriteProduct.vue';
