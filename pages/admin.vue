  ...
  <div v-if="key === 'adminadmin'">
    ...
    <form class="max-w-md mx-auto">
      ...
      <div class="relative z-0 w-full mb-7 group">
        ...
        >
          <option v-for="trans in transmission">
            {{ trans }}
          </option>
        </select>
        <label
      ...
      >
      <input
        class="block w-full mb-5 text-xs text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
        type="file"
      />
    ...
    <div
      class="relative overflow-x-auto shadow-md sm:rounded-lg max-w-7xl mx-auto mt-10"
    >
      <table class="w-full text-sm text-left rtl:text-right text-gray-500">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">Мощность</th>
            <th scope="col" class="px-6 py-3">Кузов</th>
            <th scope="col" class="px-6 py-3">КПП</th>
            <th scope="col" class="px-6 py-3">Двигатель</th>
            <th scope="col" class="px-6 py-3">Цвет</th>
        ...
        <tbody>
          ...
          >
            ...
            >
              <img class="w-16 h-9 rounded-full" :src="main.image[1]" />
              <div class="ps-3">
            ...
            <td class="px-6 py-4">{{ main.power }} л.с.</td>
            <td class="px-6 py-4">
              {{ main.kuzov }}
            </td>
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4">{{ main.price }} р.</td>
            <td class="px-6 py-4">
              <a type="button" class="font-medium text-blue-600 hover:underline"
                >Ред.
              </a>
              <a type="button" class="font-medium text-blue-600 hover:underline"
                >Удалить</a
