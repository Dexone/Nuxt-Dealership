      ...
      <a class="flex flex-col bg-white rounded-lg md:flex-row">
        <div class="relative w-full max-w-3xl">
          <div class="p-4 md:p-5">
            <ul v-for="(cartItem, index) in cartStore.localCart" class="space-y-4 mb-4">
        ...
        <!-- right bar -->
        <div v-if="Object.keys(cartStore.localCart).length > 0"
          ...
          <div class="font-light text-sm">
           ...
           <!-- заглушка -->
           <div v-if="Object.keys(cartStore.localCart).length === 0" class="bg-gray-50 border border-gray-200 rounded-lg shadow p-6 mx-auto mt-5 w-full">
