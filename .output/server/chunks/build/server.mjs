...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-D4aYGL3E.mjs');
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-eGyrzfVI.mjs').then((m) => m.default || m)
  },
  {
    name: "favourite",
    path: "/favourite",
    component: () => import('./favourite-BiN_t77f.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CV_-9B1y.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Cxr3nWPI.mjs').then((m) => m.default || m)
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import('./_id_-Dmr7NfFR.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-kAHUVExV.mjs').then((m) => m.default || m)
};
...
export { On as O, _export_sfc as _, useNuxtApp as a, asyncDataDefaults as b, createError as c, useRequestFetch as d, entry$1 as default, defineStore as e, fetchDefaults as f, br as g, hash as h, injectHead as i, useRouter as j, hasProtocol as k, resolveRouteObject as l, joinURL as m, nuxtLinkDefaults as n, navigateTo as o, parseQuery as p, useRuntimeConfig as q, resolveUnrefHeadInput as r, withoutTrailingSlash as s, useRoute as u, withTrailingSlash as w };
