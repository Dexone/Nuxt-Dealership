<template>
        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pb-5">
          <NuxtLink to="/cars">
            <a @click="page = 1" class="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span v-if="page === 1"
                class="text-blue-700 self-center text-2xl font-semibold whitespace-nowrap">DEALERSHIP</span>
              <span v-else class="self-center text-2xl text-gray-700 font-semibold whitespace-nowrap">DEALERSHIP</span>
            </a>
          </NuxtLink>
          ...
          <div class="flex items-center space-x-4 rtl:space-x-reverse font-medium pt-2">
            ...
            <NuxtLink to="/favourite" @click="page = 2">
              <button class="relative inline-flex items-center pt-1.5 px-0.5 text-sm font-medium text-center">
                <svg class="w-[29px] h-[29px] text-gray-700" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <NuxtLink to="/cart" @click="page = 3">
              <button class="relative inline-flex items-center pt-1.5 px-0.5 text-sm font-medium text-center">
                <svg class="w-[33px] h-[33px] text-gray-800 " xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  fill="none" viewBox="0 0 24 24">
            ...
            <button type="button" @click="hiddenLogin = false, blur = true"
  ...
  <button type="button" @click="hiddenLogin = true, blur = false"
    ...
    <footer
      ...
      <span class="text-sm text-gray-500 text-center mx-auto ">© 2024 <a href="https://github.com/dexone"
          class="hover:underline">Dexone</a>. All Rights Reserved.
      </span>
