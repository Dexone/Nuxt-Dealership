<template>
    ...
    <div class="flex flex-col items-center pb-10">
        <div class="flex mt-4 md:mt-6">
            ...
            <NuxtLink v-if="(Object.keys(productStore.cart)).includes(String(car.id)) === true"><button
            ...
            <span v-if="loader">
                <div role="status">
                    <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin mt-1 w-16 fill-blue-600"
            ...
            <button @click="deleteFromFavourite(car.id)"
                v-if="(Object.keys(favouriteStore.favourite)).includes(String(car.id)) === true && loader === false"
            ...
            <button v-if="(Object.keys(favouriteStore.favourite)).includes(String(car.id)) === false && loader === false"
