  ...
  <li>
    <label for="job-1"
      ...
      <div class="block">
        ...
        <a class="inline-block -ml-3 mr-2"
          v-if="cart.image[0][1].slice(cart.image[0][1].length - 11) === 'used/1.webp'">
      ...
      <div>
        ...
        <div class="items-center text-right mb-2">
          <button @click="cartStore.removeCart(cart)" class="ms-auto text-gray-500">
            <!-- x -->
            <svg class="w-3 h-4 mr-1.5 pb-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 14 14">
          ...
          <!-- кн-и избранного -->
          <button :key="quantityFavourite = Object.values(
        ...
        <div :key="quantityCart = Object.values(cartStore.localCart).reduce(function (
          ...
          <a type="button" class="px-2 py-1 text-sm font-medium text-gray-500">
            <a>
              <svg v-if="loaderCart === true" aria-hidden="true"
